...
root = Tk()
root.tk.call("wm", "iconphoto", root._w, PhotoImage(file="/home/vivaan/Documents/Programming/Python/Images/Image.gif"))
...
Label(scoreboard, text='Game Score', font=(
    'Comic Sans MS', 10, 'bold'), fg='green', bg="white").grid()
Label(scoreboard, textvariable=game.score.counter, font=(
    'Comic Sans MS', 10, 'bold'), fg='#d76737', bg="white").grid()
Label(scoreboard, text='High Score', font=(
    'Comic Sans MS', 10, 'bold'), fg='#d76737', bg="white").grid()
Label(scoreboard, textvariable=game.score.maximum, font=(
    'Comic Sans MS', 10, 'bold'), fg='#d76737', bg="white").grid()
